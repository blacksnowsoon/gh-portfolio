      ...
      <Article 
        ...
        <div className='flex flex-wrap -mx-4 '>
          ...
          <div className='flex flex-col justify-between w-full lg:w-1/2 px-4 mb-8 p-2 '>
            ...
            <div>
            <p className='via-info rounded-lg p-2 text-orange-400'>
            
              {
                card.responsive ? <span>Fully Responsive 📱Mobile & 🖥️Desktop </span> : card.responsive === undefined ? null :  <span>🖥️ Desktop Version Only</span>
              }
            </p>
            </div>
            ...
            {
              !check ? 
              <a className='btn glass  bg-orange-500 hover:bg-orange-700 rounded-lg focus:ring-4 focus:outline-none sm:mt-2' href={card.link} rel='noreferrer' target={card.link.includes('http') ? '_blank' : '_self'}>
                Check it Out
              </a>
              :
