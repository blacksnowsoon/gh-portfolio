...
const Services = () => {
  ...
  return (
    <Section >
      <SectionTilte title="What I Do" subtitle="Designing and optimizing mission-critical systems by bridging business operations, technology, and product thinking"/>
        <InnerSec>
