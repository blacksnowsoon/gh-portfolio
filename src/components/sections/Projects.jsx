  ...
  return (
    <div
      ...
      <div className='absolute bottom-0 p-2 rounded-b-lg  h-full flex flex-col justify-between'>
        <h5 className='mb-2 text-xl font-bold tracking-tight text-gray-200 dark:text-white'>{card.name}</h5>
        ...
        { !check ? <p className='mb-2 font-normal text-gray-200 dark:text-gray-200 hover:text-orange-400 ' ></p> :  
          <p className='font-bold text-orange-500 -rotate-45 text-3xl -translate-x-5' >Coming Soon...</p>}
